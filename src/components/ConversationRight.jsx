                                ...
                                if (m.senderAddress === activeAddress) {
                                    return (
                                        <div className="left" key={i}>
                                            <div>{m.content}<div className="conv-time">{m.sent.getTime()}</div></div>
                                        </div>
                                    )
                                } else {
                                    return (
                                        <div className="right" key={i}>
                                            <div className="grow"></div><div className="msg">{m.content}<div className="conv-time">{m.sent.getTime()}</div></div>
                                        </div>
                                    )
                                }
                            })
